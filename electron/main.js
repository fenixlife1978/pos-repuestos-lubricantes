...
async function handlePrintTicket(_event, ticketString) {
    ...
    const printer = new node_thermal_printer_1.ThermalPrinter({
        type: node_thermal_printer_1.PrinterTypes.STAR, // O EPSON, o el que corresponda
        interface: 'printer:POS-80', // SINTAXIS: 'printer:NOMBRE_IMPRESORA'
        characterSet: node_thermal_printer_1.CharacterSet.PC852_LATIN2,
        breakLine: node_thermal_printer_1.BreakLine.WORD, // Ayuda a prevenir cortes de palabras
...
electron_1.app.whenReady().then(() => {
    ...
    electron_1.ipcMain.handle('print-ticket', handlePrintTicket);
});
